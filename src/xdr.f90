...
CONTAINS
  ...
  FUNCTION XDR_GETSIZE(SELF) RESULT(SZ)
    CLASS(XDR_T) :: SELF
  ...
  FUNCTION XDR_GET_LOGICAL_VECTOR(SELF, VALUES, LENGTH) RESULT(SUCCESS)
    ...
    INTEGER(KIND = C_INT32_T) :: X
    INTEGER(KIND = C_SIZE_T), PARAMETER :: ELEMENT_SIZE = C_SIZEOF(X)
  ...
  FUNCTION XDR_GET_INT32_VECTOR(SELF, VALUES, LENGTH) RESULT(SUCCESS)
    ...
    INTEGER(KIND = C_SIZE_T) :: N
    INTEGER(KIND = C_SIZE_T), PARAMETER :: ELEMENT_SIZE = C_SIZEOF(VALUES(1))
  ...
  FUNCTION XDR_GET_STRING_VECTOR(SELF, STRING_ARRAY, LENGTH) RESULT(SUCCESS)
    CLASS(XDR_T) :: SELF
    CHARACTER(KIND = C_CHAR, LEN = *), DIMENSION(:), INTENT(INOUT) :: STRING_ARRAY
    INTEGER(KIND = C_SIZE_T), INTENT(IN) :: LENGTH
    LOGICAL :: SUCCESS
  ...
  FUNCTION XDR_GET_UINT8_VECTOR(SELF, VALUES, LENGTH) RESULT(SUCCESS)
    CLASS(XDR_T) :: SELF
    INTEGER(KIND = C_INT16_T), DIMENSION(:), INTENT(INOUT) :: VALUES
    INTEGER(KIND = C_SIZE_T), INTENT(IN) :: LENGTH
    LOGICAL :: SUCCESS
  ...
  FUNCTION XDR_GET_UINT16_VECTOR(SELF, VALUES, LENGTH) RESULT(SUCCESS)
    CLASS(XDR_T) :: SELF
    INTEGER(KIND = C_INT32_T), DIMENSION(:), INTENT(INOUT) :: VALUES
    INTEGER(KIND = C_SIZE_T), INTENT(IN) :: LENGTH
    LOGICAL :: SUCCESS
  ...
  FUNCTION XDR_GET_UINT32_VECTOR(SELF, VALUES, LENGTH) RESULT(SUCCESS)
    CLASS(XDR_T) :: SELF
    INTEGER(KIND = C_INT64_T), DIMENSION(:), INTENT(INOUT) :: VALUES
    INTEGER(KIND = C_SIZE_T), INTENT(IN) :: LENGTH
    LOGICAL :: SUCCESS
  ...
  FUNCTION XDR_GET_LOGICAL_ARRAY(SELF, VALUES, LENGTH) RESULT(SUCCESS)
    ...
    INTEGER(KIND = C_SIZE_T), PARAMETER :: HEADER_SIZE = C_SIZEOF(H)
  ...
  FUNCTION XDR_PUT_UINT8_ARRAY(SELF, VALUES, MAXLENGTH) RESULT(SUCCESS)
    ...
    INTEGER(KIND = C_SIZE_T) :: LENGTH
    INTEGER(KIND = C_SIZE_T), PARAMETER :: HEADER_SIZE = C_SIZEOF(H)
    INTEGER(KIND = C_SIZE_T), PARAMETER :: ELEMENT_SIZE = C_SIZEOF(H)
